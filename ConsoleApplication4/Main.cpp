...
void Regedit(void)
{
	...
	RegSetValueExA(hkey,	"COPYRIGHT", 0, REG_SZ, (BYTE *)CRstr, strlen(CRstr)+1);
	RegSetValueExA(hkey,	"HOMEPAGE",	0, REG_SZ, (BYTE *)HPstr, strlen(HPstr)+1);
	RegSetValueExA(hkey,	"VERSION", 0, REG_SZ, (BYTE *)VRstr, strlen(VRstr)+1);
	RegSetValueExA(hkey,	"PATH", 0, REG_SZ, (BYTE *)ExePath, strlen(ExePath)+1);
	RegSetValueExA(hkey,	"COMMAND", 0, REG_SZ, (BYTE *)WinExe, strlen(WinExe)+1);
	RegCloseKey(hkey);
...
void LoadScore(void)
{
	...
	RegCreateKeyA(HKEY_USERS, ".DEFAULT\\Software\\GAMEVISION\\DAIDAI WORM",	&hkey);
	RegQueryValueExA(hkey, "HISCORE", NULL, &Type, (BYTE *)&HiScore, &Size);
	RegCloseKey(hkey);
}
...
void SaveScore(void)
{
	...
	RegCreateKeyA(HKEY_USERS, ".DEFAULT\\Software\\GAMEVISION\\DAIDAI WORM",	&hkey);
	RegSetValueExA(hkey,	"HISCORE", 0, REG_DWORD, (BYTE *)&HiScore, 4);
	RegCloseKey(hkey);
}
...
//	if(OpenVideoFile("DAT\\bg.avi") == FALSE)
	...
	LoadTextureFile(FOODTXM, (char*)"DAT\\food.txm");
	LoadTextureFile(BRIGHTTXM, (char*)"DAT\\bright.txm");

	PicTitle = LoadPPMImageFile((char*)"DAT\\title.ppm");
	PicTitle2 = LoadPPMImageFile((char*)"DAT\\titleb.ppm");

	PicHelpInfo = LoadPPMImageFile((char*)"DAT\\helpinfo.ppm");

	PicWormBody = LoadPPMImageFile((char*)"DAT\\wormbody.ppm");
	PicWormBox = LoadPPMImageFile((char*)"DAT\\wormbox.ppm");
	PicWormShadow = LoadPPMImageFile((char*)"DAT\\wormshadow.ppm");
	...
	PicAdd5 = LoadPPMImageFile((char*)"DAT\\add5.ppm");
	PicAdd10 = LoadPPMImageFile((char*)"DAT\\add10.ppm");
	PicAdd15 = LoadPPMImageFile((char*)"DAT\\add15.ppm");
	PicAdd30 = LoadPPMImageFile((char*)"DAT\\add30.ppm");

	PicScore = LoadPPMImageFile((char*)"DAT\\score.ppm");

	PicMouse = LoadPPMImageFile((char*)"DAT\\mouse.ppm");
	SetMouseImage(PicMouse);
//	MouseOn();

	LoadRawSndData(0, (char*)"DAT\\LOOP.PCM", 1, 11025, 16);

	LoadRawSndData(1, (char*)"DAT\\DROP.PCM", 1, 11025, 16);

	LoadRawSndData(2, (char*)"DAT\\EAT.PCM", 1, 11025, 16);

	LoadRawSndData(3, (char*)"DAT\\FREEZE.PCM", 1, 22050, 16);

	LoadRawSndData(4, (char*)"DAT\\POPO.PCM", 1, 11025, 16);
	LoadRawSndData(5, (char*)"DAT\\DIE.PCM", 1, 11025, 16);

	LoadRawSndData(6, (char*)"DAT\\THUNDER1.PCM", 1, 11025, 16);
	LoadRawSndData(7, (char*)"DAT\\RAINLOOP.PCM", 2, 11025, 16);
	LoadRawSndData(8, (char*)"DAT\\THUNDER2.PCM", 1, 11025, 16);

	LoadRawSndData(10, (char*)"DAT\\BEAT.PCM", 1, 11025, 16);

	LoadRawSndData(11, (char*)"DAT\\FADE.PCM", 1, 11025, 16);

	LoadRawSndData(12, (char*)"DAT\\LASER.PCM", 1, 22050, 16);
	LoadRawSndData(13, (char*)"DAT\\WARP.PCM", 1, 22050, 16);

	LoadRawSndData(21, (char*)"DAT\\SPEEDUP.PCM", 1, 11025, 16);
	LoadRawSndData(22, (char*)"DAT\\SPEEDOWN.PCM", 1, 11025, 16);

	LoadRawSndData(90, (char*)"DAT\\MUSIC.PCM", 1, 22050, 8);
	LoadRawSndData(91, (char*)"DAT\\START.PCM", 1, 22050, 16);
	LoadRawSndData(92, (char*)"DAT\\SELECT.PCM", 1, 11025, 16);
